...
#include "PhaseCompressibleTurbulenceModel.H" //added compared to myinterffoam
...
int main(int argc, char *argv[])
{
    ...
    //#include "addCheckCaseOptions.H"  deleted
...
//added
	...
	cloudSU.source() = Zero;
        ...
        //runTime.printExecutionTime(Info); deleted deleted due to difference in versions
