...
{
    defineTypeNameAndDebug(PNGrowth, 0);
...
Foam::populationBalanceSubModels::growthModels::PNGrowth
::PNGrowth
(
...
Foam::populationBalanceSubModels::growthModels::PNGrowth::Kg
(
...
{   
    ...
    return 2.0/3.0*(crystal.Dm()/crystal.dm())*
    		exp (-Foam::constant::mathematical::pi*sqr(K_*log(crystal.Cc()/crystal.solubility()))/(nus_*log(supSat)))
    		*pow(crystal.solubility()/crystal.Cc(),2.0/3)
    		*pow(sqr(supSat-1.0),1.0/3)
