...
template<class Type>
void Foam::Function1Types::sawTooth<Type>::read(const dictionary& coeffs)
{
...
template<class Type>
Foam::Function1Types::sawTooth<Type>::sawTooth
(
...
template<class Type>
Foam::Function1Types::sawTooth<Type>::sawTooth(const sawTooth<Type>& se)
:
    Function1<Type>(se),
    //t0_(se.t0_),
...
template<class Type>
void Foam::Function1Types::sawTooth<Type>::writeData(Ostream& os) const
{
