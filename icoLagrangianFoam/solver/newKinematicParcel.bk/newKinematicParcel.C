...
void Foam::newKinematicParcel<ParcelType>::setCellValues
(
    TrackData& td,
    const scalar dt,
    const label cellI
...
template<class ParcelType>
template<class TrackData>
void Foam::newKinematicParcel<ParcelType>::cellValueSourceCorrection
(
    TrackData& td,
    const scalar dt,
    const label cellI
...
template<class ParcelType>
template<class TrackData>
void Foam::newKinematicParcel<ParcelType>::calc
(
    TrackData& td,
    const scalar dt,
    const label cellI
...
template<class ParcelType>
template<class TrackData>
const Foam::vector Foam::newKinematicParcel<ParcelType>::calcVelocity
(
    TrackData& td,
    const scalar dt,
    const label cellI,
...
) const
{
    ...
    const forceSuSp Feff = Fcp + Fncp; //check
    ...
    //const vector Ures = td.cloud().UIntegrator().delta(U_, dt, abp, bp);
...
template<class ParcelType>
template<class TrackData>
bool Foam::newKinematicParcel<ParcelType>::move
(
    TrackData& td,
...
template<class ParcelType>
template<class TrackData>
void Foam::newKinematicParcel<ParcelType>::hitFace(TrackData& td)
{
    typename TrackData::cloudType::parcelType& p =
        static_cast<typename TrackData::cloudType::parcelType&>(*this);
...
template<class ParcelType>
void Foam::newKinematicParcel<ParcelType>::hitFace(int& td)
{}


template<class ParcelType>
template<class TrackData>
bool Foam::newKinematicParcel<ParcelType>::hitPatch
(
    const polyPatch& pp,
    TrackData& td,
    const label patchI,
...
template<class ParcelType>
template<class TrackData>
void Foam::newKinematicParcel<ParcelType>::hitProcessorPatch
(
...
template<class ParcelType>
template<class TrackData>
void Foam::newKinematicParcel<ParcelType>::hitWallPatch
(
...
template<class ParcelType>
template<class TrackData>
void Foam::newKinematicParcel<ParcelType>::hitPatch
(
    const polyPatch&,
    TrackData& td
)
...
template<class ParcelType>
void Foam::newKinematicParcel<ParcelType>::transformProperties(const tensor& T)
{
...
template<class ParcelType>
void Foam::newKinematicParcel<ParcelType>::transformProperties
(
...
template<class ParcelType>
Foam::scalar Foam::newKinematicParcel<ParcelType>::wallImpactDistance
(
    const vector&
) const
{
...
#include "newKinematicParcelIO.C"
