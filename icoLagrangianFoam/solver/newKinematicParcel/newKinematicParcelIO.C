...
template<class ParcelType>
const std::size_t Foam::newKinematicParcel<ParcelType>::sizeofFields_
(
    sizeof(newKinematicParcel<ParcelType>)
  - offsetof(newKinematicParcel<ParcelType>, active_)
);
...
)
{
    ...
    else
    {
        ...
        (
            ...
            newKinematicParcel<ParcelType>::sizeofFields_
        );
    }
